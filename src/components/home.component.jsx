  ...
  render() {
    return (
      <div>
        <MDBRow>
          <MDBCol
            className="landing-grid bg-white"
            sm="12"
            md="12"
            lg="6"
            xl="7"
          >
            ...
            >
              ...
              <hr />
              <p>
                Videographer &#8226; Video Editor &#8226; Model &#8226; Blogger
                &#8226; Content Creator
              </p>
          ...
          <MDBCol className="landing-grid" sm="12" md="12" lg="6" xl="5">
            <div
              ...
              style={{
                backgroundImage: "url(../assets/headshot1.jpg)",
            ...
            <div
              className="dynamic-bg"
              style={{
                backgroundImage: "url(../assets/headshot2.jpg)",
                backgroundSize: "cover",
              ...
              >
                ...
                >
                  <div className="banner-text-w">
                    ...
                    <hr />
                    <p>
                      Hi there, welcome to my site. My name is Danny but I also
                      go by Que.
                      <br></br>
                      <br></br>I am a self taught videographer/video creator. I
                      love to explore the art of videography which is why I have
                ...
                >
                  <div className="banner-text-w">
                    ...
                    <p>
                      ...
                      <br></br>
                      <br></br>
                      Whether it's a show or a big event like a wedding or a
                      birthday party, I can capture it for you.
                      <br></br>
                      <br></br>
                      To see some of my work and find out if I'm a good fit for
                      you, head over to my <a href="/portfolio">
                        Portfolio
                      </a>{" "}
                      page.
                    </p>
        ...
        <MDBRow>
          <MDBCol sm="12" md="12" lg="12" xl="12">
            <div className="banner-bot">
              <h4>
                If anything you saw has interested you, or if you have any
                questions, please go over to my <a href="/contact">Contact</a>{" "}
